Feature('Mark as completed/not completed @step-06 @Se6ed235d')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @T882f50ba', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @T79204471', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T2643133b', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @T5d214a91', async ({ I, TodosPage }) => {
