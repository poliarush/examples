Feature('Edit/Delete Todos @step-06 @S02f11760')
...
Scenario('Edited todo is saved on blur @Tad6354f6', async ({ I, TodosPage }) => {
...
Scenario('Delete todos @T0cf2f3dc', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
