Feature('@first Create Todos @step:06 @smoke @story:12345 @Sb65f0554')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item @Tefec6303', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items @T9ee4ae24', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters @Tdd5f0c38', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item @T4c03b7ec', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed @T15c8c56b', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list @T03778c92', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs @Td189c9fa', async ({ I, TodosPage }) => {
